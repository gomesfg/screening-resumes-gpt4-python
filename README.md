...
- O notebook contendo as anotações está disponível [AQUI](https://github.com/gomesfg/screening-resumes-gpt4-python/blob/main/screening_resumes_using_python_gpt4.ipynb).
